...
var fotoliste =["store.jpg","street.jpg", "window.jpg", "facader.jpg"];
var musikliste =["Walker.mp3", "Bouncy_Fun_1.mp3", "Funky_Groove.mp3", "Walker.mp3"];

var fototekst = [
    "Vi startede ud med en Brunch på Le Bistor. Det var en rigtig dejlig oplevelse",
    "Vejret var fint, så gik lidt frem og tilbage på strøget. Folk så ud til at nyde det.",
    "Vi shoppede lidt i Forever 21. Super hipster, yeah!",
    "Der var spændende butiksfacader at kigge på. Her er det blevet aften, men butikkerne holder dørende åbne for handlende."
];
